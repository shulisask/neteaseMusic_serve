...
function list(id) {
  return uni.request({
    url: "".concat(_config.baseUrl, "/playlist/detail?id=").concat(id, "&realIP=116.25.146.177"),
    method: "GET" });
...
function songDetail(songId) {
  return uni.request({
    url: "".concat(_config.baseUrl, "/song/detail?ids=").concat(songId, "&realIP=116.25.146.177"),
    method: "GET" });
...
function songSimi(songId) {
  return uni.request({
    url: "".concat(_config.baseUrl, "/simi/song?id=").concat(songId, "&realIP=116.25.146.177"),
    method: "GET" });
...
function songComment(songId) {
  return uni.request({
    url: "".concat(_config.baseUrl, "/comment/music?id=").concat(songId, "&realIP=116.25.146.177"),
    method: "GET" });
...
function songLyric(songId) {
  return uni.request({
    url: "".concat(_config.baseUrl, "/lyric?id=").concat(songId, "&realIP=116.25.146.177"),
    method: "GET" });
...
function songUrl(songId) {
  return uni.request({
    url: "".concat(_config.baseUrl, "/song/url?id=").concat(songId, "&realIP=116.25.146.177"),
    method: "GET" });
...
function searchWord(word) {
  return uni.request({
    url: "".concat(_config.baseUrl, "/cloudsearch?keywords=").concat(word, "&realIP=116.25.146.177"),
    method: "GET" });
...
function searchSuggest(word) {
  return uni.request({
    url: "".concat(_config.baseUrl, "/search/suggest?keywords=").concat(word, "&type=mobile&realIP=116.25.146.177"),
    method: "GET" });
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.baseUrl = void 0;var baseUrl = "https://netease-cloud-music-api-liart-mu.vercel.app";exports.baseUrl = baseUrl;
